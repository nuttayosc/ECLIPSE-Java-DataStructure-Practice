...
public class BSTRecursive {
	...
	public int numNodesLessThan(BSTNode n,int v) {
	    ...
	    if (n == null) {
	        ...
	        count++;
	        count += numNodesLessThan(n.left, v);
	        count += numNodesLessThan(n.right, v);
	    } else {
	        count += numNodesLessThan(n.left, v);
	    }
	...
	public int numLeavesLessThan(BSTNode n, int v) {
	    ...
	    if (n == null) {
            ...
            count = count + numLeavesLessThan(n.left,v);
            count = count + numLeavesLessThan(n.right,v);
        }else {
            count = count + numLeavesLessThan(n.left,v);
        }
	...
	public int nextOf(BSTNode n,int v) {
        ...
        if (n.data > v) {
            if (n.left != null) { 
                next = nextOf(n.left, v);
                if (next < n.data && next != v) {
                	return next;
                }
            }
            next = n.data;
